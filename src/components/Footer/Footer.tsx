...
export const Footer = () => {
  ...
  return (
    <footer className="py-10 bg-primary-light">
      <div className="w-full max-w-[1920px] mx-auto layout-x-padding">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <Title size={"sm"}>SunPage</Title>
          <nav>
            <ul className="flex flex-col md:flex-row gap-4 md:gap-8 lg:gap-12 text-gray text-sm font-medium font-inter">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <nav>
            <ul className="flex flex-col md:flex-row gap-4 md:gap-8 lg:gap-12 text-sm font-medium font-inter">
